...
/* ============================================================
   ...
   ============================================================ */
var _rsPrevRAF=null,_rsPrevT=0,_rsPrevOn=false;
...
function _rsPrevDraw(){
  if(!_rsPrevOn){_rsPrevRAF=null;return;}        // läuft weiter bis stopRocketPreview()
  ...
  if(cv&&cv.getContext){
    ...
    try{
      if(typeof ROCKET_DRAWERS!=='undefined'&&ROCKET_DRAWERS[style])ROCKET_DRAWERS[style](ctx,r,t,col,1,false);
...
function startRocketPreview(){
  ...
  _rsPrevOn=true;
  if(_rsPrevRAF)return;
  _rsPrevT=0;_rsPrevRAF=requestAnimationFrame(_rsPrevDraw);
}
function stopRocketPreview(){_rsPrevOn=false;if(_rsPrevRAF){cancelAnimationFrame(_rsPrevRAF);_rsPrevRAF=null;}}
