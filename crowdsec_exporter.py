...
# Live Firewall Drops (optional, standardmäßig aus) — portiert aus Railline-Fork
...
# ====================================================
# Live Firewall Drops — /drops API (optional, DROPS_ENABLED=true)
# Liest eine gemountete JSONL-Datei (eine Zeile = ein verworfenes Paket).
# Portiert aus dem Railline-Fork.
# ====================================================
